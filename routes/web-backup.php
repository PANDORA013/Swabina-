...
// SEO Routes - Must be at the top for priority
...
// Clean URL Routes with SEO-friendly names
Route::get('/', [LandingPageController::class, 'indexClean'])->name('beranda');
Route::get('/test-structure', function() { return view('test-structure'); })->name('test.structure');
Route::get('/routes-test', function() { return view('routes-test'); })->name('routes.test');
// Layanan Routes
Route::get('/layananss', [SwaacademyController::class, 'index'])->name('layananss');
Route::get('/layananfm', [FacilityManagementController::class, 'index'])->name('layananfm');
Route::get('/layananteknologi', [DigitalSolutionController::class, 'index'])->name('layananteknologi');
Route::get('/layanandownstream', [SwatourorganizerController::class, 'index'])->name('layanandownstream');
Route::get('/layanankesehatankerja', [SwaacademyController::class, 'index'])->name('layanankesehatankerja');
...
Route::get('/visimisibudaya', [TentangkamiController::class, 'visiMisiBudaya'])->name('visimisibudaya');
Route::get('/visimisi', [TentangkamiController::class, 'visiMisiBudaya'])->name('visimisi'); // alias for old navigation
Route::get('/jejak-langkah', [TentangkamiController::class, 'jejakLangkah'])->name('jejaklangkah');
Route::get('/sertifikatpenghargaan', [TentangkamiController::class, 'sertifikat'])->name('sertifikatpenghargaan');
Route::get('/sertif', [TentangkamiController::class, 'sertifikat'])->name('sertif'); // alias for old navigation
Route::get('/memilihkami', [MkController::class, 'index'])->name('memilihkami');
// Other pages
Route::get('/news', [BeritaController::class, 'index'])->name('berita');
Route::get('/Berita', [BeritaController::class, 'index'])->name('berita1212'); // backward compatibility
...
Route::get('/Kontakkami',[KontakkamiController::class, 'index'])->name('kontakkami-alt'); // backward compatibility
Route::get('/kebijakandanpedoman', [PedomanController::class, 'pedoman'])->name('kebijakandanpedoman');
Route::get('/public', [PedomanController::class, 'pedoman'])->name('pedoman');
...
Route::group(['middleware' => ['auth', 'role:admin,marketing']], function() {
    ...
    Route::prefix('admin/jejaklangkah')->group(function () {
    ...
    Route::prefix('admin/faq')->group(function () {
        Route::get('/', [FaqController::class, 'adminIndex'])->name('admin.kontakkami.faq.index');
    ...
    // Company Info Routes (NEW - Full Admin Control)
...
// Pedoman Routes (Fixed duplicate routes)
Route::group(['middleware' => ['auth', 'role:admin,sdm,marketing']], function() {
    Route::prefix('pedoman')->name('admin.pedoman.')->group(function () {
