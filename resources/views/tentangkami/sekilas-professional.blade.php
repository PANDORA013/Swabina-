...
@section('head')
<x-seo-meta 
    title="Sekilas Perusahaan - PT Swabina Gatra"
    description="Pelajari tentang sejarah, visi, dan misi PT Swabina Gatra sebagai perusahaan terdepan dalam Facility Management."
    :keywords="['sekilas perusahaan', 'profil perusahaan', 'PT Swabina Gatra', 'about us', 'company profile']"
    url="{{ route('sekilas') }}"
/>
    ...
    <div class="col-lg-4">
        ...
        <div class="card bg-light">
            <div class="card-body">
                ...
                <a href="{{ route('kontakkami') }}" class="btn btn-primary w-100">
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm hover-lift">
                    <img src="{{ asset('assets/gambar_mengapa/integrity.jpg') }}" 
                         class="card-img-top" 
                         alt="Integritas" 
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm hover-lift">
                    <img src="{{ asset('assets/gambar_mengapa/excellent.jpg') }}" 
                         class="card-img-top" 
                         alt="Keunggulan" 
                         style="height: 180px; object-fit: cover;"
                         loading="lazy">
        ...
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm hover-lift">
                <img src="{{ asset('assets/gambar_mengapa/professional.jpg') }}" 
                     class="card-img-top" 
                     alt="Komitmen" 
                     style="height: 180px; object-fit: cover;"
                     loading="lazy">
