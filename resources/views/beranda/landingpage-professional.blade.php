...
@section('head')
<x-seo-meta 
    title="Beranda - PT Swabina Gatra"
    description="PT Swabina Gatra adalah perusahaan terdepan dalam Facility Management & Services di Indonesia dengan sertifikasi ISO lengkap dan pengalaman puluhan tahun."
    :keywords="['Swabina Gatra', 'Facility Management', 'ISO 9001', 'ISO 14001', 'ISO 45001', 'Digital Solution', 'AMDK', 'Training', 'Tour Organizer']"
    :image="asset('images/og-beranda.jpg')"
/>
    ...
    <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                <img src="{{ asset('images/carousel/' . $carousel->image) }}" 
                     class="d-block w-100" 
                     alt="{{ $carousel->title }}"
                     loading="{{ $index === 0 ? 'eager' : 'lazy' }}">
                <div class="carousel-caption">
                    <div class="container">
                        <h1 class="display-4 fw-bold">{{ $carousel->title }}</h1>
...
<div class="container">
    ...
    @if(isset($sekilasPerusahaan) && $sekilasPerusahaan->count() > 0)
    <section class="mb-5">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-12">
                <div class="card h-100 border-0 shadow-sm">
                    @if($sekilas->image)
                    <img src="{{ asset('images/sekilas/' . $sekilas->image) }}" 
                         class="card-img-top" 
                         alt="{{ $sekilas->title }}"
                         loading="lazy"
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('sekilas') }}" class="btn btn-primary mt-3">
