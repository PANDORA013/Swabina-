...
<div class="container-fluid">
    ...
    <form action="{{ route('admin.company-info.update') }}" method="POST" id="companyInfoForm">
        @csrf
        @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('company_name') is-invalid @enderror" 
                               name="company_name" value="{{ old('company_name', $companyInfo->company_name) }}" required>
                        @error('company_name')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="company_tagline" 
                               value="{{ old('company_tagline', $companyInfo->company_tagline) }}"
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control" name="company_description" rows="3"
                                  placeholder="Deskripsi singkat tentang perusahaan yang akan tampil di footer...">{{ old('company_description', $companyInfo->company_description) }}</textarea>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control @error('head_office_address') is-invalid @enderror" 
                                  name="head_office_address" rows="2" required>{{ old('head_office_address', $companyInfo->head_office_address) }}</textarea>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('head_office_city') is-invalid @enderror" 
                               name="head_office_city" value="{{ old('head_office_city', $companyInfo->head_office_city) }}" required>
                        @error('head_office_city')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('head_office_province') is-invalid @enderror" 
                               name="head_office_province" value="{{ old('head_office_province', $companyInfo->head_office_province) }}" required>
                        @error('head_office_province')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('head_office_postal_code') is-invalid @enderror" 
                               name="head_office_postal_code" value="{{ old('head_office_postal_code', $companyInfo->head_office_postal_code) }}" required>
                        @error('head_office_postal_code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control" name="branch_office_address" rows="2">{{ old('branch_office_address', $companyInfo->branch_office_address) }}</textarea>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label class="form-label fw-bold">Kota</label>
                        <input type="text" class="form-control" name="branch_office_city" 
                               value="{{ old('branch_office_city', $companyInfo->branch_office_city) }}">
                    </div>

                    <div class="col-md-4 mb-3">
                        <label class="form-label fw-bold">Provinsi</label>
                        <input type="text" class="form-control" name="branch_office_province" 
                               value="{{ old('branch_office_province', $companyInfo->branch_office_province) }}">
                    </div>

                    <div class="col-md-4 mb-3">
                        <label class="form-label fw-bold">Kode Pos</label>
                        <input type="text" class="form-control" name="branch_office_postal_code" 
                               value="{{ old('branch_office_postal_code', $companyInfo->branch_office_postal_code) }}">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" class="form-control @error('email_primary') is-invalid @enderror" 
                               name="email_primary" value="{{ old('email_primary', $companyInfo->email_primary) }}" required>
                        @error('email_primary')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" class="form-control" name="email_secondary" 
                               value="{{ old('email_secondary', $companyInfo->email_secondary) }}">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('phone_primary') is-invalid @enderror" 
                               name="phone_primary" value="{{ old('phone_primary', $companyInfo->phone_primary) }}" 
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="phone_secondary" 
                               value="{{ old('phone_secondary', $companyInfo->phone_secondary) }}" 
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="branch_phone_primary" 
                               value="{{ old('branch_phone_primary', $companyInfo->branch_phone_primary) }}" 
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="branch_phone_secondary" 
                               value="{{ old('branch_phone_secondary', $companyInfo->branch_phone_secondary) }}" 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="operating_hours_weekday_days" 
                                   value="{{ old('operating_hours_weekday_days', $companyInfo->operating_hours_weekday['days'] ?? 'Senin - Jumat') }}">
                        </div>
                        <div class="row">
                            <div class="col-4 mb-3">
                                <label class="form-label">Dari</label>
                                <input type="time" class="form-control" name="operating_hours_weekday_from" 
                                       value="{{ old('operating_hours_weekday_from', $companyInfo->operating_hours_weekday['from'] ?? '08:00') }}">
                            </div>
                            <div class="col-4 mb-3">
                                <label class="form-label">Sampai</label>
                                <input type="time" class="form-control" name="operating_hours_weekday_to" 
                                       value="{{ old('operating_hours_weekday_to', $companyInfo->operating_hours_weekday['to'] ?? '17:00') }}">
                            </div>
                            <div class="col-4 mb-3">
                                <label class="form-label">Zona</label>
                                <select class="form-select" name="operating_hours_weekday_timezone">
                                    <option value="WIB" {{ ($companyInfo->operating_hours_weekday['timezone'] ?? 'WIB') == 'WIB' ? 'selected' : '' }}>WIB</option>
                                    <option value="WITA" {{ ($companyInfo->operating_hours_weekday['timezone'] ?? '') == 'WITA' ? 'selected' : '' }}>WITA</option>
                                    <option value="WIT" {{ ($companyInfo->operating_hours_weekday['timezone'] ?? '') == 'WIT' ? 'selected' : '' }}>WIT</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="operating_hours_weekend_days" 
                                   value="{{ old('operating_hours_weekend_days', $companyInfo->operating_hours_weekend['days'] ?? 'Sabtu') }}">
                        </div>
                        <div class="row">
                            <div class="col-4 mb-3">
                                <label class="form-label">Dari</label>
                                <input type="time" class="form-control" name="operating_hours_weekend_from" 
                                       value="{{ old('operating_hours_weekend_from', $companyInfo->operating_hours_weekend['from'] ?? '08:00') }}">
                            </div>
                            <div class="col-4 mb-3">
                                <label class="form-label">Sampai</label>
                                <input type="time" class="form-control" name="operating_hours_weekend_to" 
                                       value="{{ old('operating_hours_weekend_to', $companyInfo->operating_hours_weekend['to'] ?? '12:00') }}">
                            </div>
                            <div class="col-4 mb-3">
                                <label class="form-label">Zona</label>
                                <select class="form-select" name="operating_hours_weekend_timezone">
                                    <option value="WIB" {{ ($companyInfo->operating_hours_weekend['timezone'] ?? 'WIB') == 'WIB' ? 'selected' : '' }}>WIB</option>
                                    <option value="WITA" {{ ($companyInfo->operating_hours_weekend['timezone'] ?? '') == 'WITA' ? 'selected' : '' }}>WITA</option>
                                    <option value="WIT" {{ ($companyInfo->operating_hours_weekend['timezone'] ?? '') == 'WIT' ? 'selected' : '' }}>WIT</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
function uploadCompanyLogo() {
    ...
    fetch('{{ route("admin.company-info.upload-logo") }}', {
        method: 'POST',
        body: formData
    })
...
function uploadIsoLogo(logoNumber) {
    ...
    fetch('{{ route("admin.company-info.upload-iso-logo") }}', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
