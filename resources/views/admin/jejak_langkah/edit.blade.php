...
@section('page-title', 'Edit Jejak Langkah')
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card shadow-sm">
                <div class="card-header bg-warning text-dark">
                    <h5 class="mb-0"><i class="bi bi-pencil-circle me-2"></i>Edit Jejak Langkah</h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('admin.jejak-langkah.update', $jejakLangkah->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   min="1900" 
                                   max="2100" 
                                   value="{{ old('tahun', $jejakLangkah->tahun) }}"
                                   required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                      ...
                                      name="deskripsi" 
                                      rows="5" 
                                      placeholder="Masukkan deskripsi milestone...">{{ old('deskripsi', $jejakLangkah->deskripsi) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $jejakLangkah->image) }}" 
                                     alt="{{ $jejakLangkah->tahun }}" 
                        ...
                        <div class="mb-3">
                            <label for="image" class="form-label fw-bold">
                                Gambar (Opsional - Kosongkan jika tidak ingin mengubah)
                            </label>
                            <input type="file" 
