        ...
        <div class="col-md-8 offset-md-2">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Tambah Sertifikat Baru</h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('admin.sertifikat.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                      ...
                                      name="deskripsi" 
                                      rows="4" 
                                      placeholder="Masukkan deskripsi sertifikat...">{{ old('deskripsi') }}</textarea>
                        ...
                        <div class="mb-3">
                            <label for="image" class="form-label fw-bold">
                                Gambar Sertifikat <span class="text-danger">*</span>
                            </label>
                            <input type="file" 
                        ...
                        <div class="d-flex gap-2 mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-2"></i>Simpan Sertifikat
                            </button>
