    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 footer-section">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('berita') }}">Berita & Update</a></li>
                    <li><a href="{{ route('faq') }}">FAQ</a></li>
                    <li><a href="{{ route('kebijakandanpedoman') }}">Kebijakan & Pedoman</a></li>
                    <li><a href="{{ route('kontakkami') }}">Hubungi Kami</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-3 footer-section">
                ...
                <ul style="list-style: none; padding: 0;">
                    ...
                    <li style="margin-bottom: 1rem;">
                        ...
                        <a href="tel:{{ $telp_clean }}" style="color: #ccc; text-decoration: none;">
                            {{ $telp }}
                        </a>
                    </li>
                    @endif
                    ...
                    <li style="margin-bottom: 1rem;">
                        ...
                        <a href="mailto:{{ $email }}" style="color: #ccc; text-decoration: none;">
                            {{ $email }}
                        </a>
                    </li>
                    @endif
        ...
        <div class="footer-bottom">
            <p style="margin: 0;">
                ...
                <a href="{{ route('kebijakandanpedoman') }}" style="color: #999; text-decoration: none;">Privacy Policy</a>
            </p>
        </div>
    </div>
</footer>
