                ...
                <ul class="navbar-nav mx-auto justify-content-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('layanan.show', 'swa-academy') }}">
                                <i class="bi bi-mortarboard me-2"></i>Swa Academy
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('layanan.show', 'facility-management') }}">
                                <i class="bi bi-building me-2"></i>Facility Management
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('layanan.show', 'digital-solution') }}">
                                <i class="bi bi-cpu me-2"></i>Digital Solution
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('layanan.show', 'swa-tour-organizer') }}">
                                <i class="bi bi-airplane me-2"></i>Swa Tour Organizer
                            </a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="{{ route('layanan.show', 'swasegar-amdk') }}">
