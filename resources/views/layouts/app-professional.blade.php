...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>@yield('title', 'PT Swabina Gatra - Facility Management & Services')</title>
    <meta name="description" content="@yield('description', 'PT Swabina Gatra adalah perusahaan terdepan dalam Facility Management & Services di Indonesia')">
    <meta name="keywords" content="@yield('keywords', 'facility management, services, gresik, indonesia')">
...
<body>
    ...
    <script src="{{ asset('assets/js/lazy-loader.js') }}" defer></script>
    
    <!-- Performance Monitor (Only in development/testing) -->
    @if(config('app.debug') || request()->has('perf'))
