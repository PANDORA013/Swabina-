    ...
    private function getFallbackService($slug)
    {
        $fallbackData = [
            'swa-academy' => [
                ...
                'features' => null,
                'benefits' => null,
                'meta_title' => 'SWA Academy - Pelatihan Profesional | PT Swabina Gatra',
                'meta_description' => 'Program pelatihan dan sertifikasi profesional untuk pengembangan SDM perusahaan Anda',
                'is_active' => true,
                'order' => 1,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            'facility-management' => [
                ...
                'features' => null,
                'benefits' => null,
                'meta_title' => 'Facility Management Services | PT Swabina Gatra',
                'meta_description' => 'Layanan pengelolaan fasilitas gedung profesional: cleaning, security, maintenance, dan landscaping',
                'is_active' => true,
                'order' => 2,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            'digital-solution' => [
                ...
                'features' => null,
                'benefits' => null,
                'meta_title' => 'Digital Solution & IT Services | PT Swabina Gatra',
                'meta_description' => 'Solusi digital dan transformasi IT: ERP, HRIS, website, mobile app, dan konsultasi teknologi',
                'is_active' => true,
                'order' => 3,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            'swa-tour-organizer' => [
                ...
                'features' => null,
                'benefits' => null,
                'meta_title' => 'SWA Tour Organizer - Travel & MICE | PT Swabina Gatra',
                'meta_description' => 'Layanan travel wisata, corporate gathering, MICE, umroh, dan ticketing dengan harga terbaik',
                'is_active' => true,
                'order' => 4,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            'swasegar-amdk' => [
                ...
                'features' => null,
                'benefits' => null,
                'meta_title' => 'Swasegar AMDK - Air Minum Berkualitas | PT Swabina Gatra',
                'meta_description' => 'Air minum dalam kemasan berkualitas dengan sertifikat BPOM, Halal MUI, dan ISO 9001',
                'is_active' => true,
                'order' => 5,
                'created_at' => now(),
                'updated_at' => now(),
