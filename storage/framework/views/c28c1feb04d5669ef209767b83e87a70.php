...
<section class="py-5">
            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow-sm mb-4 hover-lift">
                    <div class="card-body">
                        ...
                        <!-- Company Image -->
                        <div class="my-4">
                            <img src="<?php echo e(asset('assets/gambar-sekilas/slide1.jpeg')); ?>" 
                        ...
                        <div class="mt-4">
                            <img src="<?php echo e(asset('assets/gambar-sekilas/slide2.jpg')); ?>" 
    ...
    <div class="col-lg-4">
        <!-- Leadership Image -->
        <div class="card border-0 shadow-sm mb-4 hover-lift">
            <img src="<?php echo e(asset('assets/gambar_landingpage/foto_direksi.jpeg')); ?>" 
                 class="card-img-top" 
