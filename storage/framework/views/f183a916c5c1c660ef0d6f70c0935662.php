<?php $__env->startSection('page-title', 'Manajemen Halaman Layanan'); ?>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 shadow-sm border-0">
                ...
                <div style="height: 150px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); display: flex; align-items: center; justify-content: center;">
                    <i class="bi <?php echo e($item->icon ?? 'bi-briefcase'); ?> fs-2 text-white"></i>
                </div>
                <?php endif; ?>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div>
                            ...
                            <p class="card-text text-muted small mb-0"><?php echo e(Str::limit($item->subtitle, 60)); ?></p>
                        </div>
                    </div>
                    
                    <div class="d-flex gap-2 mt-3">
                        <a href="<?php echo e(route('admin.layanan.edit', $item->slug)); ?>" 
                           class="btn btn-sm btn-primary flex-grow-1">
                            <i class="bi bi-pencil me-1"></i> Edit
                        </a>
                        <form action="<?php echo e(route('admin.layanan.destroy', $item->slug)); ?>" 
                              method="POST" 
                    ...
                    <div class="form-check form-switch mt-3 pt-3 border-top">
                        <input class="form-check-input" type="checkbox" 
                               ...
                               onchange="updateStatus('<?php echo e($item->slug); ?>', this.checked)">
                        <label class="form-check-label small" for="status-<?php echo e($item->id); ?>">
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make($layout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project_magang\resources\views/admin/layanan/index.blade.php ENDPATH**/ ?>