...
<head>
    ...
    <link rel="preload" href="<?php echo e(asset('assets/css/bootstrap.min.css')); ?>" as="style">
    <link rel="preload" href="<?php echo e(asset('assets/js/bootstrap.bundle.min.js')); ?>" as="script">
    
    <!-- Stylesheets -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/bootstrap.min.css')); ?>" fetchpriority="high">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/swabina-optimized.css')); ?>" media="print" onload="this.media='all'">
    <noscript><link rel="stylesheet" href="<?php echo e(asset('assets/css/swabina-optimized.css')); ?>"></noscript>
