<?php $__env->startSection('page-title', 'Manajemen Sertifikat & Penghargaan'); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <?php endif; ?>
                        <div class="card-body">
                            <h5 class="card-title"><?php echo e($sertifikat->nama ?? 'N/A'); ?></h5>
                            <p class="card-text text-muted small"><?php echo e(Str::limit($sertifikat->deskripsi ?? '', 80)); ?></p>
                        </div>
                        <div class="card-footer bg-white border-top">
                            <button type="button" class="btn btn-sm btn-warning editBtn me-2" 
                                data-id="<?php echo e($sertifikat->id); ?>"
                                data-nama="<?php echo e($sertifikat->nama); ?>"
                                data-deskripsi="<?php echo e($sertifikat->deskripsi); ?>"
                                data-image="<?php echo e(asset('storage/' . $sertifikat->image)); ?>"
                                data-bs-toggle="modal" 
                                data-bs-target="#sertifikatModal">
                                <i class="fas fa-edit"></i> Edit
                            </button>
                            <button type="button" class="btn btn-sm btn-danger deleteBtn" data-id="<?php echo e($sertifikat->id); ?>">
...
<script>
    ...
    document.getElementById('sertifikatForm').addEventListener('submit', function(e) {
        ...
        let url = isEditing 
            ? `<?php echo e(url('admin/sertifikat/update')); ?>/${editId}`
            : '<?php echo e(route('admin.sertifikat.store')); ?>';
        ...
        btn.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(`<?php echo e(url('admin/sertifikat/delete')); ?>/${id}`, {
                        method: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                            'Accept': 'application/json'
...
<?php echo $__env->make($layout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project_magang\resources\views/admin/sertifikat/index.blade.php ENDPATH**/ ?>