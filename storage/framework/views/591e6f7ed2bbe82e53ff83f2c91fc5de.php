        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar d-none d-md-block">
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.contact-page.index')); ?>" class="<?php if(request()->routeIs('admin.contact-page.*')): ?> active <?php endif; ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.layanan.index')); ?>" class="<?php if(request()->routeIs('admin.layanan.*')): ?> active <?php endif; ?>">
                    ...
                    <!-- Social Media -->
                    <li>
                        <a href="<?php echo e(route('admin.social-media.index')); ?>" class="<?php if(request()->routeIs('admin.social-media.*')): ?> active <?php endif; ?>">
                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-home"></i> Dashboard</a></li>
