        ...
        <div class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto justify-content-center">
                    <!-- Home -->
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('beranda') ? 'active' : ''); ?>" href="<?php echo e(route('beranda')); ?>">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('sekilas')); ?>">
                                <i class="bi bi-file-text me-2"></i>Sekilas Perusahaan
                            </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('jejaklangkah')); ?>">
                                <i class="bi bi-diagram-3 me-2"></i>Jejak Langkah
                            </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('sertif')); ?>">
                                <i class="bi bi-award me-2"></i>Sertifikat & Penghargaan
                            </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('memilihkami')); ?>">
                    ...
                    <!-- Berita (News) -->
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('berita*') ? 'active' : ''); ?>" href="<?php echo e(route('berita')); ?>">
                    ...
                    <!-- FAQ -->
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('faq') ? 'active' : ''); ?>" href="<?php echo e(route('faq')); ?>">
                    ...
                    <!-- Kontak (Contact) -->
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('kontakkami') ? 'active' : ''); ?>" href="<?php echo e(route('kontakkami')); ?>">
...
<?php /**PATH C:\xampp\htdocs\project_magang\resources\views/partials/professional-nav.blade.php ENDPATH**/ ?>