...
<?php
    ...
    $recentBerita = \App\Models\Berita::where('id', '!=', $berita->id)
        ->latest()
        ->limit(5)
        ->get();
?>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="row g-4">
            <?php $__currentLoopData = $recentBerita->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm hover-lift">
                    <?php if($item->image): ?>
                        <img src="<?php echo e(asset('storage/' . $item->image)); ?>" 
                             class="card-img-top" 
                             alt="<?php echo e(is_array($item->title) ? $item->title[app()->getLocale()] ?? $item->title['id'] : $item->title); ?>"
                             loading="lazy"
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <h5 class="card-title fw-bold mb-2">
                            <?php echo e(Str::limit(is_array($item->title) ? $item->title[app()->getLocale()] ?? $item->title['id'] : $item->title, 60)); ?>

                        </h5>
                        <p class="card-text text-muted flex-grow-1">
                            <?php echo e(Str::limit(is_array($item->description) ? $item->description[app()->getLocale()] ?? $item->description['id'] : $item->description, 100)); ?>

                        </p>
                        
                        <div class="mt-auto pt-3 border-top">
                            <a href="<?php echo e(route('berita.show', $item->id)); ?>" class="btn btn-primary btn-sm w-100">
...
<?php echo $__env->make('layouts.app-professional', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project_magang\resources\views/news/detail.blade.php ENDPATH**/ ?>