<?php $__env->startSection('page-title', 'Manajemen Pedoman'); ?>
...
<div class="container">
    ...
    <table class="table mt-4">
        ...
        <tbody>
            <?php $__currentLoopData = $pedomans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pedoman): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td>
                    <?php if($pedoman->gambar): ?>
                        <img src="<?php echo e(asset('storage/images/' . $pedoman->gambar)); ?>" 
                             alt="Preview" style="max-width: 100px;">
                    <?php endif; ?>
                </td>
                <td><?php echo e($pedoman->judul); ?></td>
                <td style="text-align: <?php echo e($pedoman->text_align); ?>;">
                    <?php echo e($pedoman->deskripsi); ?>

                </td>
                <td><a href="<?php echo e(asset('storage/documents/' . $pedoman->file)); ?>" target="_blank">Lihat File</a></td>
                <td>
                    <button type="button" class="btn btn-sm btn-warning editBtn" 
                        data-id="<?php echo e($pedoman->id); ?>" 
                        data-judul="<?php echo e($pedoman->judul); ?>" 
                        data-file="<?php echo e($pedoman->file); ?>"
                        data-gambar="<?php echo e($pedoman->gambar); ?>"
                        data-deskripsi="<?php echo e($pedoman->deskripsi); ?>"
                        data-text-align="<?php echo e($pedoman->text_align); ?>">
                        Edit
                    </button>
                    <button type="button" class="btn btn-sm btn-danger deleteBtn" data-id="<?php echo e($pedoman->id); ?>">Hapus</button>
                </td>
            </tr>
...
<script>
    ...
    document.getElementById('pedomanForm').addEventListener('submit', function(e) {
        ...
        let url = isEditing 
            ? `<?php echo e(route('admin.pedoman.update', '')); ?>/${editId}`
            : '<?php echo e(route('admin.pedoman.store')); ?>';
        ...
        btn.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(`<?php echo e(route('admin.pedoman.destroy', '')); ?>/${id}`, {
                        method: 'DELETE',
                        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project_magang\resources\views/admin/pedoman/pedoman.blade.php ENDPATH**/ ?>