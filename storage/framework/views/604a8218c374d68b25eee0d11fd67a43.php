...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email', $email)); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>" name="password" value="<?php echo e(old('password', $password)); ?>" required>
