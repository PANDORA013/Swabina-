...
<div class="container-fluid mt-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <!-- Timeline View -->
            <div class="timeline">
                <?php $__currentLoopData = $jejakLangkahs->sortByDesc('tahun'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jejak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="timeline-item" data-id="<?php echo e($jejak->id); ?>">
                    <div class="timeline-marker">
                        <span class="timeline-year"><?php echo e($jejak->tahun ?? 'N/A'); ?></span>
                    </div>
                    <div class="timeline-content">
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="flex-grow-1">
                                <?php if($jejak->image): ?>
                                    <img src="<?php echo e(asset('storage/' . $jejak->image)); ?>" 
                                         class="img-thumbnail mb-2" 
                                         style="width: 150px; height: 100px; object-fit: cover;" 
                                         alt="Jejak Langkah" />
                                <?php endif; ?>
                                <p class="mb-0"><?php echo e($jejak->deskripsi ?? 'Tidak ada deskripsi'); ?></p>
                            </div>
                            <div class="btn-group ms-3" role="group">
                                <button type="button" class="btn btn-sm btn-warning editBtn" 
                                    data-id="<?php echo e($jejak->id); ?>"
                                    data-tahun="<?php echo e($jejak->tahun); ?>"
                                    data-deskripsi="<?php echo e($jejak->deskripsi); ?>"
                                    data-image="<?php echo e(asset('storage/' . $jejak->image)); ?>"
                                    data-bs-toggle="modal" 
                                    data-bs-target="#jejakModal">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button type="button" class="btn btn-sm btn-danger deleteBtn" data-id="<?php echo e($jejak->id); ?>">
...
<script>
    ...
    document.getElementById('jejakForm').addEventListener('submit', function(e) {
        ...
        let url = isEditing 
            ? `<?php echo e(route('admin.jejak.update', '')); ?>/${editId}`
            : '<?php echo e(route('admin.jejak.store')); ?>';
        ...
        btn.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(`<?php echo e(route('admin.jejak.destroy', '')); ?>/${id}`, {
                        method: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                            'Accept': 'application/json'
...
<?php echo $__env->make($layout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project_magang\resources\views/admin/jejak_langkah/index.blade.php ENDPATH**/ ?>