                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0"><?php echo e($beritas->count()); ?></h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0"><?php echo e($sertifikats->count()); ?></h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0"><?php echo e($faqs->count()); ?></h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0"><?php echo e($pedomans->count()); ?></h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-3 col-sm-6">
                            <a href="<?php echo e(route('admin.berita.index')); ?>" class="btn btn-outline-primary w-100">
                                <i class="fas fa-newspaper me-2"></i> Kelola Berita
                            </a>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <a href="<?php echo e(route('admin.sertifikat.index')); ?>" class="btn btn-outline-danger w-100">
                                <i class="fas fa-certificate me-2"></i> Kelola Sertifikat
                            </a>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <a href="<?php echo e(route('admin.faq.index')); ?>" class="btn btn-outline-success w-100">
                                <i class="fas fa-question-circle me-2"></i> Kelola FAQ
                            </a>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <a href="<?php echo e(route('admin.company-info.index')); ?>" class="btn btn-outline-info w-100">
